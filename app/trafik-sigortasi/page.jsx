...
const Page = () => {
  const {
    ...
    formState: { errors },
    reset,
  } = useForm({ mode: "onTouched", resolver: yupResolver(TrafikSchema) });
    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="h-screen max-w-6xl mx-auto mt-12">
        <form
          ...
          className="grid max-w-2xl grid-cols-2 gap-4 mt-6 space-y-5 sm:flex-nowrap"
        >
          {/* Steps Start */}
          ...
          >
            <input
              ...
              } p-4 uppercase border placeholder:capitalize outline-none hover:border-slate-200 rounded-xl w-full max-w-sm transition-all`}
              {...register("fullName")}
